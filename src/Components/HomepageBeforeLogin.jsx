  ...
  return (
    <>
      ...
      <div className={styles.Home_mainDiv}>
        ...
        <div className={styles.Home_mainDiv_flexDiv_ninegrid} style={{background:'white'}}>
         
          <div className={styles.Home_mainDiv_flexDiv_ContentDiv}>
            <h1 className={styles.Home_mainDiv_flexDiv_ContentDiv_h1} style={{color:'black'}}>
            Your favorite channels all in one place
            </h1>
            <p className={styles.Home_mainDiv_flexDiv_ContentDiv_p} style={{color:'black'}}>
